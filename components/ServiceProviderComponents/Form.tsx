				...
				<div className="flex flex-wrap -mx-3">
					...
					<div className="w-full md:w-1/2 px-3 mb-6">
						...
						<input
							...
							className={`w-full border-[#E5E7EB] border rounded-[6px] px-4 py-2 focus:outline-none ${
								errors.name ? "border-red-500" : "focus:border-purple-600"
							}`}
						/>
						{errors.name && (
					...
					<div className="w-full md:w-1/2 px-3 mb-6">
						...
						<input
							...
							onChange={handleChange}
							className={`w-full border-[#E5E7EB] border rounded-[6px] px-4 py-2 focus:outline-none ${
								errors.mobile ? "border-red-500" : "focus:border-purple-600"
							}`}
						/>
						{errors.mobile && (
					...
					<div className="w-full md:w-1/2 px-3 mb-6">
						...
						<input
							...
							onChange={handleChange}
							className={`w-full border-[#E5E7EB] border rounded-[6px] px-4 py-2 focus:outline-none ${
								errors.commercial_name ? "border-red-500" : "focus:border-purple-600"
							}`}
						/>
					...
					<div className="w-full md:w-1/2 px-3 mb-6 relative">
						...
						<div className="relative">
							<select
								...
								className={`w-full border-[#E5E7EB] border rounded-[6px] px-4 py-2 focus:outline-none appearance-none transition-shadow duration-200 ${
									errors.country ? "border-red-500" : "focus:border-purple-600 focus:shadow-lg"
								}`}
								style={{
					...
					<div className="w-full md:w-1/2 px-3 mb-6 relative">
						...
						<div className="relative">
							<select
								...
								className={`w-full border-[#E5E7EB] border rounded-[6px] px-4 py-2 focus:outline-none appearance-none transition-shadow duration-200 ${
									errors.city ? "border-red-500" : "focus:border-purple-600 focus:shadow-lg"
								}`}
								style={{
									WebkitAppearance: "none",
									MozAppearance: "none",
					...
					<div className="w-full md:w-1/2 px-3 mb-6 relative">
						...
						<input
							...
							onChange={handleChange}
							className={`w-full border-[#E5E7EB] border rounded-[6px] px-4 py-2 focus:outline-none pr-12 pl-4 ${
								errors.password ? "border-red-500" : "focus:border-purple-600"
							}`}
						/>
						<button
							type="button"
